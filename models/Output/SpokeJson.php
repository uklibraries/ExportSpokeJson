...
class Output_SpokeJson
{
    ...
    public function getSeriesFields()
    {
        ...
        $metadata = array(
            ...
            'keyword_t' => $keywords,
            'links_display' => metadata($item, array('Item Type Metadata', 'Series Linked Resource'), array('all' => true, 'no_filter' => true)),
    ...
    public function getInterviewFields()
    {
        ...
        if ($restriction === "False") {
            $metadata = array(
                ...
                'subject_facet' => $subjects,
                'subject_t' => $subjects,
                'links_display' => metadata($item, array('Item Type Metadata', 'Interview Linked Resource'), array('all' => true, 'no_filter' => true)),
                'title_added_entry_display' => $summary,
                'title_added_entry_t' => $summary,
                'title_display' => $title,
                'title_t' => $title,
